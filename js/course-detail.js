...
// Function to retrieve course details and populate the page
function fetchCourseDetails() {
    // Retrieve the courseId parameter from the URL
    const urlParams = new URLSearchParams(window.location.search);
    const courseId = urlParams.get('id');

// Retrieve the course details and render them on the page
...
Page content START -->
            <section class="pb-0 py-lg-5">
                                ...
                                <div class="col-md-6 col-lg-12">
                                    ...
                                    <div class="card shadow p-2 mb-4 z-index-9">
                                        <div class="overflow-hidden rounded-3">
                                            <img src="" id="courseImage" class="card-img" alt="course image">
                                            <!-- Overlay -->
                ...
                // Call the fetchCourseDetails function when the page loads
